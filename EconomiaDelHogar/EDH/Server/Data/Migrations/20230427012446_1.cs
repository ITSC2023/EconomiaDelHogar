        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VencimientoResumen = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cuentas_Divisas_DivisaId",
                        column: x => x.DivisaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Presupuestos_Divisas_DivisaId",
                        column: x => x.DivisaId,
                        principalTable: "Divisas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Movimientos_Subcategorias_SubcategoriaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movimientos_SubcategoriaId",
                table: "Movimientos",
                column: "SubcategoriaId");

            migrationBuilder.CreateIndex(
                name: "IX_Presupuestos_DivisaId",
                table: "Presupuestos",
                column: "DivisaId");
        }
